<template>
	<view class="content">
		<view class="logo">
			<image :style='{"boxShadow":"0 0 16rpx #59f43e","borderColor":"#ccc","borderRadius":"40rpx","borderWidth":"2rpx","width":"160rpx","borderStyle":"solid","url":"http://codegen.caihongy.cn/20210405/a6b1b060587d41b398984c819c57c2a6.jpg","isShow":true,"height":"160rpx"}' src='http://codegen.caihongy.cn/20210405/a6b1b060587d41b398984c819c57c2a6.jpg' mode="aspectFill"></image>
		</view>
		...
		<view class="links">
            ...
            <view>|</view>
                        			            <view class="link-highlight" @tap="onRegisterTap('shangjia')" :style='{"color":"rgba(23, 152, 242, 1)","fontSize":"24rpx"}'>注册商家</view>
            <view>|</view>
